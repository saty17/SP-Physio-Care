...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['action']) and $_POST['action'] == 'appointment' ) {
        $email = (isset($_POST["email"])) ? $_POST["email"] : 'recipient@example.com';
        $subject = "Subject Appointment Email"; // Replace your Subject Here
        $to = "recipient@example.com"; // Replace your Email Here
        $headers = "From: $email\r\n";
        $headers .= "Reply-To: $email\r\n";
        $headers .= "Content-type: text/html\r\n";
        $message = "Appointment Message"; // Replace Your Message Subscribe
